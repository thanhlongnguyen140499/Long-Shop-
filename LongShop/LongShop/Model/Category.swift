...
// use only on time -> to create category in firebase
...
//    let health = Category(_name: "Health & Beauty", _imageName: "healthy")
...
//    let industry = Category(_name: "Indestry & Business", _imageName: "industry")
//    let garden = Category(_name: "Garden supplies", _imageName: "garden")
//    let camera = Category(_name: "Cameras & Optics", _imageName: "camera")
//    
//    let arrayOfCategories = [womenClothing, footWear, menClothing, electronics, health, baby, home, car, luggage, jewelery, hobby,pet,industry, garden, camera]
//    
